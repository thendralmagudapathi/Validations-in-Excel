...
worksheet.data_validation('O2:O300', {'validate': 'decimal:decimal', 'criteria': 'between', 'minimum': 1, 'maximum': 1000, 'input_title': 'Enter', 'input_message': 'As Value:Value', 'error_title': 'Input value is not valid!', 'error_message': 'Must be a ratio'})
